...
var r = db.r;
module.exports.getHistoryFireSensorValue = function(device_id,callback) { 
...
module.exports.getFireValue = function(device_id,callback) {  
		r.table("sm_sensors").innerJoin(
		  r.table("sm_device_mapping"),
		  function (sensor, map) { 
		    return sensor("port").eq(map("port_id"));
...
module.exports.getCurrentFireSensor = function(device_id,callback) { 
	r.table("sm_sensors").innerJoin(
		  r.table("sm_device_mapping"),
		  function (sensor, map) { 
		    return sensor("port").eq(map("port_id"));
